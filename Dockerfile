...
# 1226  gcloud run deploy gcp-status-service     --image us-central1-docker.pkg.dev/surfn-peru/gcp-status/gcp_status:latest     --platform managed     --region us-central1     --allow-unauthenticated
